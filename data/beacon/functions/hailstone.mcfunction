scoreboard players reset @a t_hailstone
...
execute if score travellers travellers matches 1.. run title @a[tag=travelling] actionbar ["",{"text":"Travelling to ","color":"green"},{"text":"Hailstone","color":"aqua"},{"text":" standby...","color":"green"}]
