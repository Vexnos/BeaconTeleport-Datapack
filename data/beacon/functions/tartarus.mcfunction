scoreboard players reset @a t_tartarus
...
execute if score travellers travellers matches 1.. run scoreboard players set tartarus tartarus 1
execute if score travellers travellers matches 1.. run title @a[tag=travelling] actionbar ["",{"text":"Travelling to ","color":"green"},{"text":"Tartarus","color":"red"},{"text":" standby...","color":"green"}]
