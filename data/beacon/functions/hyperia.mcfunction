scoreboard players reset @a t_hyperia
...
execute if score travellers travellers matches 1.. run scoreboard players set hyperia hyperia 1
execute if score travellers travellers matches 1.. run title @a[tag=travelling] actionbar ["",{"text":"Travelling to ","color":"green"},{"text":"Hyperia","color":"dark_aqua"},{"text":" standby...","color":"green"}]
